      ...
      <div className="mb-6 shadow-xl rounded-2xl border p-6">
        <div className="space-y-4">
          <p className="text-lg text-gray-800 dark:text-gray-300">
            ...
            <TTS text="Este recurso ha sido desarrollado como parte del módulo de Soporte Técnico del Bachillerato Técnico en Informática. Está pensado para estudiantes de 15 a 16 años, con el fin de fortalecer habilidades prácticas y técnicas." />
          </p>
          <p className="text-lg text-gray-800 dark:text-gray-300">
            ...
            básicas.
            <TTS text="A través de módulos temáticos, videos, actividades prácticas y autoevaluaciones, podrás explorar el fascinante mundo del mantenimiento de computadores, aprendiendo desde cómo limpiar tu equipo hasta cómo diagnosticar fallas o realizar reparaciones básicas." />
          </p>
        </div>
      </div>
      ...
      <div className="mb-6 shadow-xl rounded-2xl border p-6">
        <div className="space-y-4">
          ...
          <p className="text-gray-800 dark:text-gray-300">
            ...
            Informática:
            <TTS text="Este recurso contribuye al desarrollo de la siguiente destreza del currículo oficial ecuatoriano para el Bachillerato Técnico en Informática." />
          </p>
          <blockquote className="border-l-4 pl-4 italic text-gray-700 dark:text-gray-300">
            ...
            y software.”
            <TTS text="Aplica técnicas de mantenimiento preventivo y correctivo de computadores personales, identificando problemas comunes en hardware y software." />
          </blockquote>
          <p className="text-gray-800 dark:text-gray-300">
            ...
            <TTS text="Esta destreza pertenece al eje temático Tecnologías de la información y comunicación, dentro de la Unidad de Competencia 4." />
          </p>
      ...
      <div className="mb-6 shadow-xl rounded-2xl border p-6">
        <div className="space-y-4">
          ...
          <p className="text-gray-800 dark:text-gray-300">
            ...
            <TTS text="Cada módulo incluye explicaciones paso a paso, recursos adicionales y actividades interactivas para reforzar lo aprendido." />
          </p>
        </div>
      </div>
